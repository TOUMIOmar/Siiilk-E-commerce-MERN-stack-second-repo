...
useEffect(()=>{
  ...
  return (
    <div>
     {(Currnetpath !==("http://localhost:3000/Comptepartenaire")
     &&Currnetpath !==("http://localhost:3000/admin")
     &&Currnetpath !==("http://localhost:3000/dashbord")
     &&Currnetpath !==("http://localhost:3000/upload")
     &&Currnetpath !==("http://localhost:3000/update")
     &&Currnetpath !==("http://localhost:3000/request")
     &&Currnetpath !==("http://localhost:3000/product")
     )?
       <Navbar pro={omar}/> : <></>
     }
